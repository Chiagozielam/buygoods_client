...
import style from "./css/computersPage.module.css";
          ...
          <Grid.Row>
            ...
            <Grid.Column className={style.tags} width={3}>
              <Card>
                <Card.Content>
                  <Image
                    src="https://compuscience.com.eg/297-large_default/best-ups-ups-system-max-600-va.jpg"
                    avatar
                  />
                  UPS
                </Card.Content>
            ...
            <Grid.Column className={style.tags} width={3}>
              <Card>
                <Card.Content>
                  <Image
                    src="https://img2.exportersindia.com/product_images/bc-full/2019/6/1014176/scanner-1560228380-4945424.jpeg"
                    avatar
                  />
                  Scanners
                </Card.Content>
            ...
            <Grid.Column className={style.tags} width={3}>
              <Card>
                <Card.Content>
                  <Image
                    src="https://assets.bose.com/content/dam/Bose_DAM/Web/consumer_electronics/global/products/speakers/companion_2_series_iii_multimedia_speaker_system/product_silo_images/companion2_black_EC.psd/_jcr_content/renditions/cq5dam.web.320.320.png"
                    avatar
                  />
                  Speaker
                </Card.Content>
            ...
            <Grid.Column width={3}>
              <Card>
                <Card.Content>
                  <Image
                    src="https://i.ebayimg.com/images/g/lUUAAOSwopRYiRFo/s-l300.jpg"
                    avatar
                  />
                  Mouse
                </Card.Content>
            ...
            <Grid.Column width={3}>
              <Card>
                <Card.Content>
                  <Image
                    src="https://5.imimg.com/data5/WD/TB/CQ/SELLER-34778367/jumper-wire-500x500.jpg"
                    avatar
                  />
                  Accessories
                </Card.Content>
